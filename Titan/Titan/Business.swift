...
class Business: NSObject {
    ...
    var coordinate: (longitude:NSNumber , latitude:NSNumber)?
    ...
    init(dictionary: NSDictionary) {
        ...
        if location != nil {
            ...
            if let coordinateDict = location!["coordinate"] as? NSDictionary {
                ...
                longtitude = coordinateDict["longitude"] as! NSNumber
                latitude = coordinateDict["latitude"] as! NSNumber
                
            }
        }
        self.address = address
        self.coordinate = (longtitude ,latitude)
