...
typedef void (^CheckShouldSelectResultHandler)(BOOL shouldSelect);
...
- (void)qb_imagePickerController:(QBImagePickerController *)imagePickerController asset:(PHAsset *)asset completion: (CheckShouldSelectResultHandler) completion;
...
@property (nonatomic, assign) BOOL allowsImageSelectMultipleTimes;
